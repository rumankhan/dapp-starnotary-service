...
contract StarNotary is ERC721 {
    ...
    string public constant name = "High Five Token";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        string memory starInfo = tokenIdToStarInfo[_tokenId].name;
        return starInfo;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender) ,"Neither tokenId1 nor tokenId2 is the sender");
